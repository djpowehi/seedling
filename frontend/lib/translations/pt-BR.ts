...
export const ptBR: Translations = {
  ...
  "card.ready.eyebrow": "Pronto pra enviar",
  "card.ready.monthly": "Mesada do(a) {kid} · ${amount}",
  "card.ready.bonus": "Décimo terceiro do(a) {kid}",
  "card.ready.cta": "Enviar agora",
  ...
  "card.monthly_on": "Mesada em {date}",
  "card.send_bonus": "Enviar bônus",
  "card.bonus_on": "Bônus em {date}",
