...
export const ptBR: Translations = {
  ...
  "history.subtitle.one": "1 evento on chain · clique numa linha pra ver no Solscan",
  "history.subtitle.other": "{n} eventos on chain · clique numa linha pra ver no Solscan",
