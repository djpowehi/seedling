...
export const ptBR: Translations = {
  ...
  "history.title": "entre seus filhos",
  "history.subtitle.one": "1 evento · clique numa linha pra ver o comprovante",
  "history.subtitle.other":
    "{n} eventos · clique numa linha pra ver o comprovante",
  "history.expand": "ver mais {n}",
  "history.collapse": "ver menos",
  "card.activity.row.created": "Família criada",
  "card.activity.row.deposit": "Depósito",
  "card.activity.row.gift": "Presente recebido",
  "card.activity.row.gift_from": "Presente de {name}",
  "card.activity.row.withdraw": "Saque",
  "card.activity.row.monthly": "Mesada mensal",
  "card.activity.row.bonus": "13º (bônus)",
  "card.activity.row.closed": "Família encerrada",
  "card.activity.just_now": "agora",
  "card.activity.minutes_ago": "{n}min atrás",
  "card.activity.hours_ago": "{n}h atrás",
  "card.activity.days_ago": "{n}d atrás",
  ...
  "card.monthly_on.day": "Mesada em {date} — falta 1 dia",
  "card.monthly_on.days": "Mesada em {date} — faltam {days} dias",
  "card.send_bonus": "Enviar bônus",
  "card.bonus_on.day": "Bônus em {date} — falta 1 dia",
  "card.bonus_on.days": "Bônus em {date} — faltam {days} dias",
  ...
  "kid.gift_combined.hint": "Pix · carteira cripto · de qualquer lugar",
  "kid.gift_chooser.eyebrow": "COMO VOCÊ QUER ENVIAR?",
  "kid.gift_chooser.crypto.line": "carteira cripto",
  "kid.gift_chooser.crypto.hint": "Solana Pay · qualquer carteira",
  "kid.gift_chooser.cancel": "cancelar",
  ...
  "kid.payouts.eyebrow": "seu histórico de mesada",
  "kid.payouts.empty": "sua primeira mesada chega em {date}",
  "kid.payouts.empty.unknown": "sua primeira mesada está a caminho",
  "kid.payouts.monthly": "mesada mensal",
  "kid.payouts.bonus": "décimo terceiro 🎁",
