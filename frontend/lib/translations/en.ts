...
export const en = {
  ...
  "card.ready.eyebrow": "Ready to send",
  "card.ready.monthly": "{kid}'s monthly allowance · ${amount}",
  "card.ready.bonus": "{kid}'s year-end bonus",
  "card.ready.cta": "Send now",
  ...
  "card.monthly_on": "Monthly on {date}",
  "card.send_bonus": "Send bonus",
  "card.bonus_on": "Bonus on {date}",
