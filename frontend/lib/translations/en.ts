...
export const en = {
  ...
  "history.title": "across your kids",
  "history.subtitle.one": "1 event · click a row for the receipt",
  "history.subtitle.other": "{n} events · click a row for the receipt",
  "history.expand": "show {n} more",
  "history.collapse": "show less",
  "card.activity.row.created": "Family created",
  "card.activity.row.deposit": "Deposit",
  "card.activity.row.gift": "Gift received",
  "card.activity.row.gift_from": "Gift from {name}",
  "card.activity.row.withdraw": "Withdrawal",
  "card.activity.row.monthly": "Monthly allowance",
  "card.activity.row.bonus": "Year-end bonus",
  "card.activity.row.closed": "Family closed",
  "card.activity.just_now": "just now",
  "card.activity.minutes_ago": "{n}m ago",
  "card.activity.hours_ago": "{n}h ago",
  "card.activity.days_ago": "{n}d ago",
  ...
  "card.withdraw_pix": "withdraw to MoonPay",
  "card.soon": "soon",
  "card.draft.badge": "awaiting first deposit",
  "card.draft.deposit_hint":
    "First deposit creates the on-chain vault. Use MoonPay or top up to fund.",
  "card.send_monthly": "Send monthly",
  "card.sending": "sending…",
  "card.monthly_on.day": "Monthly on {date} — 1 day remaining",
  "card.monthly_on.days": "Monthly on {date} — {days} days remaining",
  "card.send_bonus": "Send bonus",
  "card.bonus_on.day": "Bonus on {date} — 1 day remaining",
  "card.bonus_on.days": "Bonus on {date} — {days} days remaining",
  "card.bonus_loading": "Bonus in …",
  "card.remove_kid": "remove kid",
  "card.removing": "removing…",
  "card.edit_kid": "edit",
  "card.pix.label": "payout destination",
  "card.pix.empty": "+ add payout destination",
  "card.edit.eyebrow": "edit family",
  "card.edit.close": "close ✕",
  "card.edit.name.label": "name",
  "card.edit.name.placeholder": "Maria",
  "card.edit.pix.label": "payout destination",
  "card.edit.pix.placeholder": "email or phone",
  "card.edit.monthly.label": "monthly · USDC",
  "card.edit.save": "save changes",
  "card.edit.saving": "saving…",
  "card.edit.error.pix": "payout destination format is invalid",
  ...
  "add_kid.pix_key.label": "payout destination",
  "add_kid.pix_key.optional": "(optional · for off-ramp payouts)",
  "add_kid.pix_key.placeholder": "email or phone",
  "add_kid.pix_key.hint":
    "where the off-ramp delivers when you cash out. yours if the kid doesn't have one yet.",
  ...
  "kid.gift_combined.hint": "Pix · crypto wallet · anyone, anywhere",
  "kid.gift_chooser.eyebrow": "HOW DO YOU WANT TO SEND?",
  "kid.gift_chooser.crypto.line": "crypto wallet",
  "kid.gift_chooser.crypto.hint": "Solana Pay · any wallet",
  "kid.gift_chooser.cancel": "cancel",
  "kid.gift_pix.line": "gift in BRL via Pix",
  "kid.gift_pix.hint": "no crypto wallet needed",
  "kid.gifts_received": "gifts received",
  "kid.payouts.eyebrow": "your allowance history",
  "kid.payouts.empty": "your first allowance lands {date}",
  "kid.payouts.empty.unknown": "your first allowance is coming",
  "kid.payouts.monthly": "monthly allowance",
  "kid.payouts.bonus": "year-end bonus 🎁",
