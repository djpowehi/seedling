...
const SITE_DESCRIPTION =
  "Programmable allowance for families on Solana. Money grows, habits grow, kids grow with both. Parents deposit USDC once, it earns yield via Kamino, and the kid is paid on the 1st of every month plus a year-end bonus from everything it earned.";
